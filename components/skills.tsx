...
const fallbackCommits = 5;

interface Props {
  commits: number;
}

const opactiyForBlock = (sectionProgress: number, blockNo: number) => {
  const progress = sectionProgress - blockNo;
  if (progress >= 0 && progress < 1) return 1;
  return 0.2;
};

export const Skills: React.FC<Props> = ({ commits }) => {
      ...
      <div className="min-h-screen max-w-5xl mx-auto px-10 lg:px-20 py-24 md:py-28 lg:py-36 flex flex-col justify-center items-center text-4xl md:text-6xl lg:text-7xl tracking-tight font-semibold">
        <div className="leading-[1.15]">
          <div
            ...
            style={{
              opacity: opactiyForBlock(progress, 0),
            }}
          >
          ...
          <span
            ...
            style={{
              opacity: opactiyForBlock(progress, 1),
            }}
          >
          ...
          <span
            ...
            style={{
              opacity: opactiyForBlock(progress, 2),
            }}
          >
            We&apos;re maintaing some of the most popular open-sourcep rojects,
